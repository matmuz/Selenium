...
public class BaseTest {
    ...
    public void setUp() throws IOException {
        ...
        testData = TestData.get("src\\main\\resources\\testdata\\test-data.json");
        userData = TestData.get("src\\main\\resources\\testdata\\existing-user.json");
        guestData = TestData.get("src\\main\\resources\\testdata\\guest-user.json");
        newUserData = TestData.get("src\\main\\resources\\testdata\\new-user.json");
